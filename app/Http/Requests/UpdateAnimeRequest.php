...
class UpdateAnimeRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'slug' => [
                ...
                'string',
                'max:128',
                Rule::unique('animes', 'slug')->ignore($this->id),
            ],
            'name' => [
                'required',
                'string',
    ...
    {
        return [
            'id.required' => 'ID аніме є обов’язковим.',
            'id.ulid' => 'ID аніме має бути у форматі ULID.',
            'id.exists' => 'Вказане аніме не існує.',
